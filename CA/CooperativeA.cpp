...
bool CooperativeA::recursiveWaitAndReturn(const Agent& unit, const map::Cell& target, CA::Cell* currentCell, CA::Cell* parentCell, int& waitT, std::vector<CA::Cell>& path, Reservation& table) {
